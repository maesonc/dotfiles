...
nnoremap <leader>ev :vs ~/Dropbox/vim/vimrc.vim<cr>
...
nmap <silent><leader>fl :CocList --input=flutter commands<CR>
nmap <silent><leader>fe :CocList FlutterEmulators<CR>
nmap <silent><leader>fd :CocList FlutterDevices<CR>
