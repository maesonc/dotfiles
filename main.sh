...
then
	...
	brew tap homebrew/cask-fonts && brew install --cask font-iosevka-term-nerd-font
else
	...
	git sparse-checkout add patched-fonts/IosevkaTerm;
	source install.sh IosevkaTerm;
fi
